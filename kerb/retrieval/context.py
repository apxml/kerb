...
from .structures import SearchResult, FilterConfig
...
def compress_context(
    ...
    if strategy_str == "top_k":
        ...
        for result in results:
            ...
            sentences = [s.strip() + "." for s in result.document.content.split(".") if s.strip()]
        ...
        compressed = []
        total_chars = 0
        docs_to_include = min(len(results), max_chars // (max_chars // max(1, len(results))))
