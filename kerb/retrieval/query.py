...
if TYPE_CHECKING:
    from kerb.core.enums import QueryStyle, ExpansionMethod
...
def rewrite_query(
    ...
    if style_str == "clear":
        ...
        words = query.lower().split()
        # Remove common words
        stop_words = {"how", "what", "when", "where", "why", "who", "which", "the", "a", "an", "and", "or", "but", "in", "on", "at", "to", "for", "of", "with", "by", "from", "is", "are", "was", "were"}
