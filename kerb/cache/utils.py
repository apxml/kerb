...
from .backends import MemoryCache, DiskCache, TieredCache, LLMCache
...
def export_cache_stats(
    cache: Union[BaseCache, LLMCache], 
    format: Union['ExportFormat', str] = "dict"
) -> Union[Dict, str]:
...
def estimate_cache_size(
    cache: BaseCache, 
    unit: Union['SizeUnit', str] = "entries"
) -> Union[int, str]:
