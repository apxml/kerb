    ...
    def generate(
        ...
        **kwargs
        ...
        if self.behavior == MockBehavior.FIXED:
            ...
            content = random.choice(self.responses) if self.responses else self.default_response
    ...
    def assert_called_with(self, prompt_contains: str) -> None:
        ...
        for call in self.call_history:
            if prompt_contains in call["prompt"]:
                return
        raise AssertionError(f"Mock LLM was not called with prompt containing: {prompt_contains}")
