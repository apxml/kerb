...
class PromptTestSuite:
            ...
            for i, test_input in enumerate(test_case.test_inputs):
                ...
                try:
                    ...
                    result = TestResult(
                        ...
                        expected_output=test_case.expected_outputs[i] if test_case.expected_outputs and i < len(test_case.expected_outputs) else None,
                        error=error,
                        latency=latency
                    )
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_latency": sum(r.latency for r in self.results) / total if total > 0 else 0.0
        }
