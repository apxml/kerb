...
def merge_chunks(chunks: List[str], max_size: int = 2000, separator: str = "\n\n") -> List[str]:
...
def optimize_chunk_size(text: str, target_size: int = 1000, 
...
def custom_chunker(text: str, chunk_size: int = 1000, 
                   split_fn: Optional[Callable[[str], List[str]]] = None) -> List[str]:
