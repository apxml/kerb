...
def calculate_semantic_similarity(
    text1: str,
    text2: str,
    method: Union['SimilarityMethod', str] = "embedding"
) -> float:
    ...
    if method_str == "jaccard":
        ...
        total_docs = 2
        doc_freq = {term: (1 if term in tf1 else 0) + (1 if term in tf2 else 0) for term in all_terms}
        idf = {term: math.log(total_docs / freq) if freq > 0 else 0 for term, freq in doc_freq.items()}
