...
def load_csv(file_path: str, parse_as_dict: bool = True, encoding: str = 'utf-8') -> Document:
    """Load a CSV file.
...
def load_html(file_path: str, extract_text: bool = True, encoding: str = 'utf-8') -> Document:
    """Load an HTML file.
